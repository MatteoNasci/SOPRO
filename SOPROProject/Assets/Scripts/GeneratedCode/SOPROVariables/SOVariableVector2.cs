...
namespace SOPRO
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "SOVariableVector2", menuName = "SOPRO/Variables/Vector2")]
    public class SOVariableVector2 : ScriptableObject
    {
#if UNITY_EDITOR
        /// <summary>
        ...
        /// </summary>
        /// <param name="value">new value</param>
        public void SetValue(SOVariableVector2 value)
        {
        ...
        public static implicit operator Vector2(SOVariableVector2 variable)
        {
